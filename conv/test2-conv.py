...
def energy(timescale, timestep, number_of_triangles=30,rheology = "VP",solver = "FE",stabilised = 0):
    ...
    """
    all_u, all_h, all_a, mesh, zeta = vp_evp_test_explicit(timescale, timestep, number_of_triangles, rheology,advection=True, solver=solver,subcycle=5,stabilised=stabilised)
    eta = zeta * e ** (-2)
