...
for state in [True, False]:
    ...
    dirname_evp = path + "/evp_u_timescale={}_timestep={}_stabilised={}.pvd".format(
        timescale, timestep, state
    )
    dirname_vp = path + "/vp_u_timescale={}_timestep={}_stabilised={}.pvd".format(
        timescale, timestep, state
    )
